...
- *NER*: [unimelb-nlp/wikiann](https://huggingface.co/datasets/unimelb-nlp/wikiann)
- *Sentiment*: [Stanford Sentiment Treebank](https://nlp.stanford.edu/sentiment/)
- *Word* (aka Tweets): [TweetEval](https://github.com/cardiffnlp/tweeteval)
- *WSD*: [CoarseWSD-20](https://github.com/danlou/bert-disambiguation)
